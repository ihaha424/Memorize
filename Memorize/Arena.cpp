...
Arena::Arena(World* _world) : Actor(_world)
{
	...
	Math::Vector2 urWallVertex0 = MAP_VERTEX_0 - Math::Vector2{ 0, 500 };
	Math::Vector2 urWallVertex1 = MAP_VERTEX_1 + Math::Vector2{ 500, 0 };
	...
	Math::Vector2 rWallVertex0 = MAP_VERTEX_1 + Math::Vector2{ 500, 0 };
	Math::Vector2 rWallVertex1 = MAP_VERTEX_2 + Math::Vector2{ 500, 0 };
	...
	Math::Vector2 lrWallVertex0 = MAP_VERTEX_2 + Math::Vector2{ 500, 0 };
	Math::Vector2 lrWallVertex1 = MAP_VERTEX_3 + Math::Vector2{ 0, 500 };
	...
	Math::Vector2 llWallVertex1 = MAP_VERTEX_3 + Math::Vector2{ 0, 500 };
	Math::Vector2 llWallVertex2 = MAP_VERTEX_4 - Math::Vector2{ 500, 0 };
	...
	Math::Vector2 lWallVertex2 = MAP_VERTEX_4 - Math::Vector2{ 500, 0 };
	Math::Vector2 lWallVertex3 = MAP_VERTEX_5 - Math::Vector2{ 500, 0 };
	...
	Math::Vector2 ulWallVertex0 = MAP_VERTEX_0 - Math::Vector2{ 0, 500 };
	Math::Vector2 ulWallVertex1 = MAP_VERTEX_0;
	Math::Vector2 ulWallVertex2 = MAP_VERTEX_5;
	Math::Vector2 ulWallVertex3 = MAP_VERTEX_5 - Math::Vector2{ 500, 0 };
